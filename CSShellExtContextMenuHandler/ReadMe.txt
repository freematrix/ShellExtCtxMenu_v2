...
It adds the menu item "Display File Name (C#)" to the context menu when you 
right-click a .cs file in the Windows Explorer. Clicking the menu item 
brings up a message box that displays the full path of the .cs file.
...
(C#)" menu item in the context menu and a menu seperator below it. Clicking 
the menu item brings up a message box that displays the full path of the .cs 
file.
...
registered.
  ...
  In this code sample, we insert the menu item "Display File Name (C#)", and 
  add a menu seperator below it.
